	...
	Model(glm::vec3(-8.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0))
{
	...
	base->set_texture(LoadMipmapTexture(GL_TEXTURE0, "../ResourceFiles/lamp_post.png"));
	add(base);
	...
	bar->set_texture(LoadMipmapTexture(GL_TEXTURE0, "../ResourceFiles/lamp_post.png"));
	add(bar);
	...
	light_case->set_texture(LoadMipmapTexture(GL_TEXTURE0, "../ResourceFiles/lamp_post.png"));
	add(light_case);
