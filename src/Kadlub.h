...
private:
	std::vector<GLfloat> vertices = {
		...
		0.18f, -0.5f, -0.1f,		0.91f,  1.0f,// 8
		0.18f, -0.4f, -0.1f,		0.1f,  0.0f,// 9
		-0.18f, -0.4f, -0.1f,	0.0f,  0.0f,// 10
		-0.18f, -0.5f, -0.1f,	0.95f,  0.0f,// 11
		-0.2f, -0.5f, -0.1f,		0.9f,  0.0f,// 12
		-0.2f, -0.4f, -0.1f,		0.8f,  0.0f,// 13

		-0.4f, 0.0f, 0.1f,		0.5f,  0.1f,// 14
		-0.4f, 0.2f, 0.1f,		0.4f,  0.1f,// 15
		-0.2f, 0.6f, 0.1f,		0.0f,  0.1f,// 16
		0.2f, 0.6f, 0.1f,		0.0f,  0.9f,// 17
		0.4f, 0.2f, 0.1f,		0.4f,  0.9f,// 18
		0.4f, 0.0f, 0.1f,		0.5f,  0.9f,// 19
		0.2f, -0.4f, 0.1f,		0.8f,  0.9f,// 20
		0.2f, -0.5f, 0.1f,		0.9f,  0.9f,// 21
		0.18f, -0.5f, 0.1f,		0.91f,  1.0f,// 22
		0.18f, -0.4f, 0.1f,		0.1f,  0.2f,// 23
		-0.18f, -0.4f, 0.1f,	0.0f,  0.2f,// 24
		-0.18f, -0.5f, 0.1f,	0.95f,  0.1f,// 25
		-0.2f, -0.5f, 0.1f,		0.9f,  0.1f,// 26
		-0.2f, -0.4f, 0.1f,		0.8f,  0.1f,// 27
